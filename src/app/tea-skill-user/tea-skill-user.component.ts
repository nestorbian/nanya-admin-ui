...
@Component({
  selector: 'app-tea-skill-user',
  templateUrl: './tea-skill-user.component.html',
  styleUrls: ['./tea-skill-user.component.scss']
})
export class TeaSkillUserComponent implements OnInit {
  // 错误提示弹窗
  ...
  onloadData(pageNum: number, pageSize: number): void {
    this.userService.findAllTeaSkill(pageNum, pageSize).subscribe((data) => {
